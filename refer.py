...
def sub(train, test, best_iter):
    ...
    sub=pd.read_csv('input/round1_ijcai_18_test_a_20180301.txt', sep="\s+")
...
if __name__ == "__main__":
    train = pd.read_csv('input/round1_ijcai_18_train_20180301.txt', sep="\s+")
    test = pd.read_csv('input/round1_ijcai_18_test_a_20180301.txt', sep="\s+")
